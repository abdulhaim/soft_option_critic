...
class HalfCheetahHFieldEnv(MujocoEnv, gym.utils.EzPickle):
    FILE = "/Users/marwaabdulhai/Desktop/git repos/soft_option_critic/gym_env/assets/half_cheetah_hfield.xml"

    def __init__(self, task='hill', reset_task_every_episode=False, *args, **kwargs):
